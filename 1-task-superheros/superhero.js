...
let captainamerica = new Superhero(
  "Капитан Америка",
  "Marvel Comics",
  "Стивен Роджерс",
  "супер-солдат",
  ...
  for (let i = 0; i < parsedHeroes.length; i++) {
    ...
    listHeroes +=
      ...
      (hero.image == undefined
        ? ``
        : `<img class="imgHero" src="${hero.image}"/>`) +
